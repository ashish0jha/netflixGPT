...
const Home = () => {
  ...
  return (
    ...
    <div>
        <div className="bg-black bg-opacity-60 absolute w-full h-[855px]"></div>
        ...
        <div>
            {
              loginbtn===true 
              ? <div  className="absolute top-1/3 left-1/3 w-5/12 flex flex-col items-center">
              ...
              : <div >
                  ...
                  <form  className="absolute top-1/4 left-1/3 w-3/12 flex flex-col p-10 bg-black bg-opacity-70 rounded-lg">
                    ...
                    <button className="m-3 px-3 rounded-md font-semibold py-1 bg-red-600 text-white">{signup ? "Sign UP" : "Sign In"}</button>
